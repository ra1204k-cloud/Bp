export const seasonsData = [
  {
    ...
    description: "Shreesh enters college with high vibes, but immediately gets locked in a battle of AC controls, existential train delays at Bareilly,",
  ...
  },
  {
    ...
    episodes: [
      ...
      },
      {
        ...
        dialogs: [
          { sender: "Harsh", text: "Bhai sorry sorry. Mujhe laga block hu mai... unblocked status nahi pata تھا." },
